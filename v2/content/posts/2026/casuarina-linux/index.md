...
date = 2026-05-16T14:22:36+10:00

# [extra]
# updated = 2026-01-27T09:25:58+10:00
+++

Over the past months I've been working on a Linux distribution derived from [Chimera Linux], and it's
now available for download. The distribution is called Casuarina Linux. It swaps out musl in Chimera
for glibc to gain binary compatibility with the wider GNU/Linux ecosystem.
...
Most of the heavy lifting was done by [nina][q66] in creating Chimera Linux. I used that excellent
base to build Casuarina. It inherits most of the composition of Chimera, with the exception of
glibc:

- [LLVM] toolchain
- [Dinit] init system
- [GNU libc][glibc]
- [FreeBSD derived core
utilities][chimerautils]
...
functionality, compatible, and easy to understand and contribute to. I've been using as the
primary OS on my laptop and desktop for personal and day job computing since mid-April.
